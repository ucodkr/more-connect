...
const FILE_NAME = "more-connect-ollama.json";
const CONFIG_NAME = "connections-storage.json";

export class OllamaStore {
  private items: OllamaEndpoint[] = [];
  ...
  private async readFile(folder: vscode.Uri): Promise<OllamaEndpoint[] | undefined> {
    try {
